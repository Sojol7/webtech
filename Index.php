<?php
session_start();
require_once 'try/table.php';
require_once 'try/register.php';
?>
...
<!-- Box 2: Info box -->
  <div class="column">
    <div class="login" id="green">
      <form class="login-form" onsubmit="return validateLogin()" action="process.php" method="POST" >
        <h2>Login</h2>
